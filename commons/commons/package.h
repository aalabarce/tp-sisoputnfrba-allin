...
t_stream * paquetizarStruct_conectame(t_struct_nombreNivelYSimbolo * estructuraOrigen); //D
...
t_stream * paquetizarStruct_datosNivel2(t_struct_datosNivel * estructuraOrigen); //D
...
t_stream * paquetizarStruct_algoritmo(t_struct_algoritmo * estructuraOrigen); //D
t_stream * paquetizarStruct_posicionYSimbolo(t_struct_posxposy_simbolo * estructuraOrigen); //E
t_stream * paquetizarStruct_simboloDibujame(t_struct_simbolo_dibujame * estructuraOrigen); //E
t_stream * paquetizarStruct_pedirPosicionRecurso(t_struct_pedir * estructuraOrigen); //E
t_stream * paquetizarStruct_asignarRecurso(t_struct_asignar * estructuraOrigen); //E
