...
/*
 * @NAME: list_include
 * @DESC: Determina si el elemento pertenece a la lista.
 */

bool list_include (t_list* self, void * element){
	bool _identity (void * otherElement){
		//return ((char*)element==(char*)otherElement);
		return (string_equals_ignore_case((char*)element,(char*)otherElement));
	}




	return list_any_satisfy(self,_identity);
}
...
int list_get_index(t_list* self, bool(*condition)(void*)){
	int index;
